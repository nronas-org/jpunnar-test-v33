...
export const customer = [
  ...
  rest.head('/login.php', async (req, res, ctx) => {
    ...
    return res(ctx.status(302), ctx.cookie(BIGCOMMERCE_API_TOKEN_NAME, nanoid(), { expires }))
  }),
  ...
  graphql.query('GetCustomer', async (req, res, ctx) => {
    ...
    if (bigcommerceCustomerAccessToken !== undefined && bigcommerceCustomerAccessToken.length > 0) {
